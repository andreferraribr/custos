...
### Ranking custeio administrativo (cliente + UDs)
...
Por exemplo: 1 servidor trabalhou por 11 meses = 1 força de trabalho  
...
renderPlotly(
  ...
  ggplot(pessoal_reactive()  , aes(x = custo_pessoal, y = forca_trabalho, label = reais(custo_pessoal))) + 
