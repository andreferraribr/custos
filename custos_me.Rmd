...
Por exemplo: se um servidor trabalhou por 11 meses, a força de trabalho é igual a um.  
...
A segmentação do custo de pessoal entre clientes e UDs foi feita a partir das uorgs. Dependendo da uorg, determinado custo foi alocado para os clientes ou para a UDs.
...
* Incluir o custo de pessoal dos servidores cedidos, dos demais clientes (ex. CGU)
